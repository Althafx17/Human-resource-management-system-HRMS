      ...
      <div className={styles.actions}>
        ...
        <div className={styles.profileContainer}>
          ...
          >
            ...
            <img 
              src={activeManager && typeof activeManager.avatar === 'string' && activeManager.avatar ? activeManager.avatar : 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="%2394a3b8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>'} 
          ...
          {isDropdownOpen && managers.length > 0 && (
            <div className={styles.dropdown}>
              {managers.map(manager => (
                ...
                >
                  <img
                    src={typeof manager.avatar === 'string' && manager.avatar ? manager.avatar : 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="%2394a3b8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>'}
                    alt={manager.name}
